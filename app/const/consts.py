...
Начни диалог с ним, нажми "Выбрать подарок другу" и введи мой уникальный код <b>{code}</b>
'''

FRIENDS_INVITATION_BY_PHONE = '''
Привет 👋
https://t.me/ai_wish_bot - этот бот может рассказать тебе, что я хочу в подарок.
Начни диалог с ним, нажми "Выбрать подарок другу" и введи мой номер телефона <b>{phone_number}</b>
'''
