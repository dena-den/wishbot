...
Привет 👋
Этот бот может рассказать тебе, что я хочу в подарок.
Начни диалог с ним, выбери "Выбрать подарок другу" и введи мой уникальный код <b>{code}</b>
'''

FRIENDS_INVITATION_BY_PHONE = '''
Привет 👋
Этот бот может рассказать тебе, что я хочу в подарок.
Начни диалог с ним, выбери "Выбрать подарок другу" и введи мой номер телефона <b>{phone_number}</b>
'''
