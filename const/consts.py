...
Твой уникальный код: <b>{user_id}</b> - поделись им с друзьями 📲
"""

MY_WISHES_EMPTY_BOTTOM = """
<b>Твой список желаний пуст.</b> Их можно добавить с помощью кнопок ниже.\n
Твой уникальный код: <b>{user_id}</b> - поделись им с друзьями 📲
"""
...
⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️\n
<b>Это список подарков твоего друга: {name}, {birthdate}</b>
